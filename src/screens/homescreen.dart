...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    _controller = TabController(length: 3, vsync: this); // banyaknya tab
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: 39.h, // ukuran menu yang di scrolling
                  ...
                  //        _buildgridview(moroccanrecipes),
                          _buildgridview(makanan),
                          _buildgridview(minuman),
                  //        _buildgridview(indonesiarecipes),
                        ]);
                      }
                      return Container();
                    },
  ...
  GridView _buildgridview(List<Recipe> list) {
    return GridView.builder(
        ...
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 2, // jumlah menu dalam satu baris
            childAspectRatio: 1 / 2,
            crossAxisSpacing: 15, // jarak antar 2 menu, awalnya 12
            mainAxisSpacing: 30),
