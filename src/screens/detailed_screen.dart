...
class _DetailedScreenState extends State<DetailedScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        // mengahapus tampilan website di menu detail resep
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          SizedBox(
                            width: 65.w, //jarak text dengan icon star
                            child: Text(
                              widget.recipe.name,
                              maxLines: 12, // awal 2, jumlah paraghraf pada text
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: Theme.of(context)
                                      ...
                                      .headline1!
                                      .copyWith(
                                          fontSize: 12.sp, // awal 14, ukuran rating
                                          color: Colors.black,
                        ...
                        Row(
                          ...
                          children: [
                            _infowidget(context,
                                ...
                                title: 'menit'), // awal mins
                    // menghapus tampilan servs di menu detail menu
                    /*        _infowidget(context,
                                data: 03.toString(),
                                icon: Icons.people,
                                title: 'servs'), */
                    // menghapus tampilas cal
                    /*        _infowidget(context,
